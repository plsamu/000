...
* [DEV](dev/README.md)
  * [JS & NodeJS](dev/js-and-nodejs/README.md)
    ...
    * [NodeJS](dev/js-and-nodejs/nodejs/README.md)
      * [Custom Modules](dev/js-and-nodejs/nodejs/custom-modules.md)
      * [Crypthography](dev/js-and-nodejs/nodejs/crypthography/README.md)
        * [Encrypt with Node, decrypt with Android](dev/js-and-nodejs/nodejs/crypthography/encrypt-with-node-decrypt-with-android.md)
      * [database](dev/js-and-nodejs/nodejs/database/README.md)
        * [postgresSQL](dev/js-and-nodejs/nodejs/database/postgressql/README.md)
          * [faststart](dev/js-and-nodejs/nodejs/database/postgressql/faststart.md)
          * [create database](dev/js-and-nodejs/nodejs/database/postgressql/create\_database.md)
          * [connect to database](dev/js-and-nodejs/nodejs/database/postgressql/connect\_2\_database.md)
