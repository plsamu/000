...
* [DEV](dev/README.md)
  * [Theory](dev/theory/README.md)
    * [Anti-Pattern](dev/theory/anti-pattern.md)
    * [Design Principles (SOLID & GRASP)](dev/theory/design-principles-solid-and-grasp/README.md)
      * [SOLID](dev/theory/design-principles-solid-and-grasp/solid/README.md)
        * [Single-responsibility principle](dev/theory/design-principles-solid-and-grasp/solid/single-responsibility-principle.md)
        * [Open–closed principle](dev/theory/design-principles-solid-and-grasp/solid/open-closed-principle/README.md)
          * [Inheritance](dev/theory/design-principles-solid-and-grasp/solid/open-closed-principle/inheritance.md)
          * [Interfaces / Polymorphism](dev/theory/design-principles-solid-and-grasp/solid/open-closed-principle/interfaces-polymorphism.md)
        * [Liskov substitution principle](dev/theory/design-principles-solid-and-grasp/solid/liskov-substitution-principle.md)
        * [Interface segregation principle](dev/theory/design-principles-solid-and-grasp/solid/interface-segregation-principle.md)
        * [Dependency inversion principle](dev/theory/design-principles-solid-and-grasp/solid/dependency-inversion-principle.md)
      * [GRASP](dev/theory/design-principles-solid-and-grasp/grasp.md)
    * [Software Design Pattern](dev/theory/software-design-pattern/README.md)
      * [Creational patterns](dev/theory/software-design-pattern/creational-patterns.md)
        * [Factory method pattern](dev/theory/software-design-pattern/creational-patterns/factory-method-pattern.md)
      ...
      * [Structural patterns](dev/theory/software-design-pattern/structural-patterns.md)
        * [Facade pattern](dev/theory/software-design-pattern/structural-patterns/facade-pattern.md)
        * [Proxy pattern](dev/theory/software-design-pattern/structural-patterns/proxy-pattern.md)
        * [Decorator pattern](dev/theory/software-design-pattern/structural-patterns/decorator-pattern.md)
      * [Behavioral patterns](dev/theory/software-design-pattern/behavioral-patterns.md)
        * [Observer pattern](dev/theory/software-design-pattern/behavioral-patterns/observer-pattern.md)
      * [Concurrency patterns](dev/theory/software-design-pattern/concurrency-patterns.md)
        * [Read write lock pattern](dev/theory/software-design-pattern/concurrency-patterns/read-write-lock-pattern.md)
        * [Monitor Object](dev/theory/software-design-pattern/concurrency-patterns/monitor-object.md)
  ...
  * [Rust](dev/rust/README.md)
    ...
    * [Code](dev/rust/code/README.md)
      * [Binary, Libraries, Modules & Packages](dev/rust/code/binary-libraries-modules-and-packages/README.md)
        * [mod.rs VS lib.rs](dev/rust/code/binary-libraries-modules-and-packages/mod.rs-vs-lib.rs.md)
      * [Environment variable](dev/rust/code/environment-variable.md)
      * [Backend](dev/rust/code/backend/README.md)
        * [Actix](dev/rust/code/backend/actix.md)
      ...
      * [Result](dev/rust/code/result.md)
  ...
  * [Mobile dev](dev/mobile-dev/README.md)
    * [Android](dev/mobile-dev/android-kotlin/README.md)
      * [Background Functionalities](dev/mobile-dev/android/background-functionalities/README.md)
    ...
    * [React Native](dev/mobile-dev/react-native/README.md)
      * [Components](dev/mobile-dev/react-native/components/README.md)
        * [Circle](dev/mobile-dev/react-native/components/circle.md)
  ...
  * [GIT, Github, Gitbook](dev/git-and-github/README.md)
    * [remote server on LAN](dev/git-github-gitbook/remote-server-on-lan.md)
...
* [mProjects](ideas/README.md)
  ...
  * [Microservices Templates](ideas/microservices-templates/README.md)
    * [Rust](ideas/microservices-templates/rust/README.md)
      * [000 - autorestart, log disable/enable](ideas/microservices-templates/rust/001-autorestart-log-disable-enable.md)
