...
* [DEV](dev/README.md)
  ...
  * [Kotlin](dev/android-kotlin/README.md)
    ...
    * [Code](dev/android-kotlin/code/README.md)
      ...
      * [Current Time](dev/android-kotlin/code/current-time-in-milliseconds.md)
  ...
  * [Mobile dev](dev/mobile-dev/README.md)
    * [Android](dev/mobile-dev/android/README.md)
      * [UI](dev/mobile-dev/android/ui/README.md)
        ...
        * [Hide/Show Action Bar](dev/mobile-dev/android/ui/hide-show-action-bar.md)
        * [Toolbar](dev/mobile-dev/android/ui/toolbar.md)
        * [Trasparent Activity](dev/mobile-dev/android/ui/trasparent-activity.md)
      * [Fragments System](dev/mobile-dev/android/fragments-system.md)
      * [Permission](dev/mobile-dev/android/permission.md)
      * [Storage Systems](dev/mobile-dev/android/storage-systems/README.md)
        * [Downloaded files](dev/mobile-dev/android/storage-systems/downloaded-files.md)
        * [SqliteOpenHelper](dev/mobile-dev/android/storage-systems/sqliteopenhelper.md)
        * [Android Room](dev/mobile-dev/android/storage-systems/android-room/README.md)
          * [Database Client](dev/mobile-dev/android/storage-systems/android-room/database-client.md)
      * [Deprecation](dev/mobile-dev/android/deprecation/README.md)
        * [OnActivityResultListener - onActivityResult - startActivityForResult](dev/mobile-dev/android/deprecation/onactivityresultlistener-onactivityresult-startactivityforresult.md)
      * [Notifications](dev/mobile-dev/android/notifications.md)
      * [Curiosity](dev/mobile-dev/android/curiosity.md)
      * [Error List Collection](dev/mobile-dev/android/error-list-collection.md)
      * [Background Communication](dev/mobile-dev/android/background-communication.md)
      * [Unique ID](dev/mobile-dev/android/unique-id.md)
...
* [Cybersec](cybersec/README.md)
  ...
  * [Roadmap](cybersec/roadmap/README.md)
    ...
    * [002 - Medium level](cybersec/roadmap/002-medium-level/README.md)
      * [Router Vulnerabilities](cybersec/roadmap/002-medium-level/router-vulnerabilities.md)
      * [WIP](cybersec/roadmap/002-medium-level/wip/README.md)
        * [Databases for cybersec](cybersec/roadmap/002-medium-level/wip/databases-for-cybersec.md)
        * [How to Find Router Make, Model, Firmware Type and Revision Info?](cybersec/roadmap/002-medium-level/wip/how-to-find-router-make-model-firmware-type-and-revision-info.md)
        * [NMAP](cybersec/roadmap/002-medium-level/wip/nmap.md)
        * [Map the city](cybersec/roadmap/002-medium-level/wip/map-the-city.md)
